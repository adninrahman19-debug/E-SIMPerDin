...
import { Building2, Plus, Search, MapPin, CheckCircle, MoreHorizontal } from 'lucide-react';
        ...
        <div className="p-4 bg-gray-50 border-b border-gray-100 flex items-center justify-between">
          <div className="relative w-full md:w-96">
            ...
            <input 
              ...
              className="w-full pl-10 pr-4 py-2 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-900/10 transition-all"
            />
          </div>
        </div>
                ...
                <tr key={inst.id} className="hover:bg-blue-50/20 transition-all">
                  <td className="px-6 py-4">
                    <div className="flex items-center">
                      <div className="w-10 h-10 rounded-lg bg-blue-100 flex items-center justify-center text-blue-900 mr-4">
                        <Building2 size={20} />
                      </div>
                      <div>
                        <p className="font-bold text-gray-900">{inst.name}</p>
                        <p className="text-xs text-gray-400">Terdaftar sejak Jan 2024</p>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4 text-sm font-mono font-semibold text-blue-800">
                    {inst.code}
                  </td>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center text-green-600 text-xs font-bold uppercase">
                      <CheckCircle size={14} className="mr-1.5" /> Berlangganan
                    </div>
                  </td>
                  <td className="px-6 py-4">
